...
Run `git checkout gh-pages` and then `ng build --output-path docs --base-href ./` for deploy app in [https://adrianagui.github.io/posts-board/](https://adrianagui.github.io/posts-board/) \
